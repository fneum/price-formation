...
\begin{figure}
	...
	\begin{tabular}{ll}
		...
		\includegraphics[width=0.48\textwidth]{../results/elastic-2000-nobat-zero/graphics/supply_demand_2010-07-01 00:00.pdf} &
		\includegraphics[width=0.48\textwidth]{../results/elastic-2000-nobat-zero/graphics/supply_demand_2010-01-01 00:00.pdf} \\
		Case C: Price set by electrolyser & Case D: Price set by wind and solar \\
		\includegraphics[width=0.48\textwidth]{../results/elastic-2000-nobat-zero/graphics/supply_demand_2010-07-01 12:00.pdf} &
		\includegraphics[width=0.48\textwidth]{../results/elastic-2000-nobat-zero/graphics/supply_demand_2010-03-01 16:00.pdf} \\
	\end{tabular}
	\centering
	\includegraphics[width=0.38\textwidth]{../results/elastic-2000-nobat-zero/graphics/price_duration_attributed.pdf}
	\includegraphics[width=\textwidth]{../results/elastic-2000-nobat-zero/graphics/energy_balance.pdf}
...
\begin{figure}
	\centering
	\footnotesize\sffamily
	\includegraphics[width=0.39\textwidth]{../results/graphics/elasticity/price_durations.pdf}
	\includegraphics[width=0.38\textwidth]{../results/graphics/elasticity/price_durations_log.pdf}
...
\begin{figure}
	...
	\begin{tabular}{cc}
		...
		\includegraphics[width=0.48\textwidth]{../results/elastic-2000/graphics/hydrogen_bidding.pdf} &
		\includegraphics[width=0.48\textwidth]{../results/elastic-2000-zero/graphics/hydrogen_bidding.pdf} \\
		(c) battery bidding with storage cost & (d) battery bidding with free storage  \\
		\includegraphics[width=0.48\textwidth]{../results/elastic-2000/graphics/battery_bidding.pdf} &
		\includegraphics[width=0.48\textwidth]{../results/elastic-2000-zero/graphics/battery_bidding.pdf} \\
	\end{tabular}
...
\Cref{fig:bidding} presents specific examples of what the storage bidding look
